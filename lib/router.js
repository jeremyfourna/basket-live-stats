...
Router.route('/gameDefinition/:_id', {
	name: 'gameDefinition',
	waitOn: function() {
		return [subscriptions.subscribe('clubName'), subscriptions.subscribe('oneGame', this.params._id), subscriptions.subscribe('championshipLevel'), subscriptions.subscribe('championshipGroup')];
	},
	data: function() {
		return Games.findOne(this.params._id);
	}
