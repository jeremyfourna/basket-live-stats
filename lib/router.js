...
Router.route('/gameDefinition/:_id', {
	name: 'gameDefinition',
	waitOn: function() {
		return [subscriptions.subscribe('clubs'), subscriptions.subscribe('games'), subscriptions.subscribe('federationConfig')];
	},
	data: function() {
		return Games.findOne(this.params._id);
	}
...
Router.route('/participantsDefinition/:_id', {
	...
	waitOn: function() {
		return [subscriptions.subscribe('clubs'), subscriptions.subscribe('games')];
	},
	data: function() {
		return Games.findOne(this.params._id);
	}
...
Router.route('/myClub/newTeamDefinition', {
	...
	waitOn: function() {
		return [subscriptions.subscribe("federationConfig"), subscriptions.subscribe('clubs')];
	},
	data: function() {
		return Clubs.findOne({
			createdBy: Meteor.userId()
...
Router.route('/myClub/teamEdition', {
	name: 'teamEdition',
	waitOn: function() {
		return [subscriptions.subscribe('clubs'), subscriptions.subscribe('federationConfig')];
	},
	data: function() {
		return Clubs.findOne({
			createdBy: Meteor.userId()
