...
Router.route('/gameStats/:_id', {
	name: 'gameStats',
	waitOn: function() {
		return [subscriptions.subscribe('oneGame', this.params._id), subscriptions.subscribe('playersForAGame', this.params._id), subscriptions.subscribe('coachsForAGame', this.params._id)];
	}
});
