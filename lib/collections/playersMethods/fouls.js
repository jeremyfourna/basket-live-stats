Meteor.methods({
	...
	correctionTechFouls: function(playerId) {
		Players.update({
			_id: playerId
		}, {
			$inc: {
	...
	antiSportFouls: function(playerId) {
		Players.update({
			_id: playerId
		}, {
			$inc: {
	...
	correctionAntiSportFouls: function(playerId) {
		Players.update({
			_id: playerId
		}, {
			$inc: {
	...
	disqualifyingFouls: function(playerId) {
		Players.update({
			_id: playerId
		}, {
			$inc: {
	...
	correctionDisqualifyingFouls: function(playerId) {
		Players.update({
			_id: playerId
		}, {
			$inc: {
