Meteor.methods({
	...
	techFoulsTeamYourClub: function(gameId) {
		Games.update({
			_id: gameId
		}, {
			$inc: {
	...
	correctionTechFoulsTeamYourClub: function(gameId) {
		Games.update({
			_id: gameId
		}, {
			$inc: {
	...
	antiSportFoulsTeamYourClub: function(gameId) {
		Games.update({
			_id: gameId
		}, {
			$inc: {
	...
	correctionAntiSportFoulsTeamYourClub: function(gameId) {
		Games.update({
			_id: gameId
		}, {
			$inc: {
	...
	disqualifyingFoulsTeamYourClub: function(gameId) {
		Games.update({
			_id: gameId
		}, {
			$inc: {
	...
	correctionDisqualifyingFoulsTeamYourClub: function(gameId) {
		Games.update({
			_id: gameId
		}, {
			$inc: {
